...
<head>
    ...
    <link href="<?= app_e(app_asset_versioned('assets/vendor/bootstrap.min.css')) ?>" rel="stylesheet">
    <link href="<?= app_e(app_asset_versioned('assets/vendor/tabler-icons.min.css')) ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?= app_e(app_asset_versioned('assets/vendor/aos.css')) ?>">
