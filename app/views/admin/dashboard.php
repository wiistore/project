...
<div class="dashboard-page">
    ...
    <section class="dashboard-grid">
        <article class="dashboard-card dashboard-card-large" data-animate="fade-right" data-delay="80">
        ...
        <article class="dashboard-card" data-animate="fade-left" data-delay="140">
            <div class="dashboard-card-header">
                <div>
    ...
    <section class="dashboard-grid dashboard-grid-bottom">
        <article class="dashboard-card" data-animate="fade-right" data-delay="120">
            <div class="dashboard-card-header">
                <div>
        ...
        <article class="dashboard-card" data-animate="fade-left" data-delay="180">
            <div class="dashboard-card-header">
                <div>
                    <span>Aktivitas</span>
    ...
    <section class="dashboard-shortcuts" data-animate="fade-up" data-delay="140">
