// js halaman riwayat transaksi: filter search + metode bayar di sisi client
(function () {
    'use strict';
    ...
    // filter row tabel berdasarkan keyword + metode pembayaran, tanpa request ulang ke server
